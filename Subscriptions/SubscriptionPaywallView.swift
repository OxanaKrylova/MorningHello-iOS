...
enum SubscriptionPaywallMode: Equatable {
    ...
    struct MorningHelloPaywallView: View {
        ...
        private var morningHelloTermsOfUseURL: URL {
            URL(
                string: isEnglish
        ...
        private var appleTermsOfUseLink: some View {
            Link(
                localizedText(
                    ru: "Условия использования Apple",
                    en: "Apple Terms of Use"
                ),
        ...
        private var morningHelloTermsOfUseLink: some View {
            Link(
                localizedText(
                    ru: "Условия использования MorningHello",
                    en: "MorningHello Terms of Use"
                ),
                destination: morningHelloTermsOfUseURL
            )
        }
