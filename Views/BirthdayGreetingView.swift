...
struct BirthdayGreetingView: View {
    ...
    private let phrases: [String] = [
        ...
        "С днём рождения! Пусть каждый год жизни становится ещё ярче, добрее и счастливее.",
        "Пусть в день рождения тебя окружают забота, тепло и любимые люди.",
        "Желаю хорошего самочувствия, спокойных дней и радостных встреч.",
        "Пусть каждый новый день дарит повод улыбнуться и почувствовать себя счастливым.",
        "Желаю уютного дома, добрых разговоров и приятных сюрпризов.",
        "Пусть впереди будет много светлых дней и маленьких поводов для радости.",
        "Желаю сил для любимых дел и времени для того, что приносит удовольствие.",
        "Пусть рядом будут люди, с которыми легко смеяться и хорошо молчать.",
        "Желаю мира в душе, тепла в сердце и добрых новостей.",
        "Пусть этот год подарит новые впечатления и исполнение заветных желаний.",
        "Желаю приятных прогулок, тёплых встреч и красивых моментов каждый день.",
        "Пусть день рождения будет наполнен заботой, улыбками и любимыми голосами.",
        "Желаю крепкого здоровья, душевного равновесия и уверенности в завтрашнем дне.",
        "Пусть в жизни всегда найдётся место чуду, надежде и хорошему настроению.",
        "Желаю радоваться простым вещам и находить красоту в каждом дне.",
        "Пусть впереди ждут добрые перемены, счастливые встречи и много поводов для улыбки."
    ]
